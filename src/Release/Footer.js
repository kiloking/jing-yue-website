...
function Footer() {
  ...
  return (
    <div
      className='w-full h-full  bg-cover bg-bottom bg-no-repeat pt-20 relative '
      style={{
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="w-full mx-auto pt-5  rel" data-aos="fade-up" data-aos-duration="1500" >
              ...
              <div className='flex gap-3'>
                <div className='w-full  '>
                  <select className="block  bg-white  w-full px-3 py-2  rounded-full"  {...register("main_district", { required: true})} onChange={(e)=>{
                    handleChange(e)
                  }}>
                ...
                <div className='w-full  '>
                  <select className="block  bg-white  w-full px-3 py-2   rounded-full"  {...register("sub_district", { required: true})}>
              ...
              <div className='flex flex-col md:w-1/2 mx-auto gap-4 my-3 md:mt-8'>
                <button className=' text-white bg-gradient-to-l from-[#A25D31]  to-[#D9A271]   border-2 px-2 py-2  font-bold w-full    text-md tracking-wide rounded-full' type='submit'>確認送出</button>
